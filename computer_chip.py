...
class ComputerChipIcon(VGroup):
    def __init__(
        ...
        **kwargs,
        ...
        c_mark.set_stroke(stroke_color, width=1.6, opacity=0.75)
...
def make_computer_chip_icon(size=3.2, **kwargs):
    return ComputerChipIcon(size=size, **kwargs)


class ComputerChip(Scene):
    def construct(self):
        self.camera.background_color = BLACK

        chip = ComputerChipIcon()
        self.add(chip)
        self.wait()
